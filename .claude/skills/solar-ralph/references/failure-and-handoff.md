...
> Generated by `/solar-ralph finalize`. Must be written to `data/results/ralpthon/solar/<run-id>/HANDOFF.md`.
...
All run state is located in `data/results/ralpthon/solar/<run-id>/`:
